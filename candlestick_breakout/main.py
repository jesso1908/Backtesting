...
from strategy import percent
# from strategy import chart_
# from positionsize import examplesizerdetection
...
datapath="E:/Backtest project/candlestick_breakout/BANKNIFTY_F1_5min.csv"
...
if __name__=="__main__":
	...
	cerebro.addstrategy(percent)
	data=bt.feeds.GenericCSVData(
	dataname=datapath,
	fromdate=dt.datetime(2009,7,12),
	todate=dt.datetime(2011,1,1),
	datetime=0,
